    ...
    return (
        ...
        >
            ...
            <Typography variant="h4" style={{ maxWidth: '800px', marginBottom: '20px' }}>
                : İş Gücü Yönetimini Yeniden Tanımlayın
            </Typography>
            <Typography variant="body1" style={{ maxWidth: '800px', marginBottom: '40px' }}>
                İnsan kaynakları yönetimi, bir işletmenin en önemli unsurlarından biridir. , personel yönetimini
            ...
            <Typography variant="body1" style={{ maxWidth: '800px', marginBottom: '40px' }}>
                , güçlü raporlama ve analiz araçlarıyla donatılmıştır. Çalışan verilerini analiz edin, performans
            ...
            <Typography variant="body1" style={{ maxWidth: '800px', marginBottom: '40px' }}>
                ile işinizi geleceğe taşıyın. Sürekli güncellenen modüllerimizle İK yönetimini bir üst seviyeye çıkarın.
