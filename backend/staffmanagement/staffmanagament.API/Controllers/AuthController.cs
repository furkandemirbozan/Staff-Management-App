...
namespace staffmanagament.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(UserManager<User> userManager, SignInManager<User> signInManager, ITokenService tokenService, IEmployeeServices employeeService, IEmailService emailService)
        {
